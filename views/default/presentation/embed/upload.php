...
<?php
	...
	//echo elgg_view('presentation/embed/tabs',array('tab' => 'upload','internalname'=>get_input('internalname')));
	echo elgg_view('presentation/embed/tabs',array('tab' => 'upload'));
	...
	<script type="text/javascript"> 
        ...
        //$(document).ready(function() { 
            ...
            $('#mediaUpload').submit(function() { 
	            var options = {  
				    success:    function() { 
				        $('.popup .content').load('<?php echo $vars['url'] . "pg/presentation/$username/embed/media"; ?>?internalname=<?php echo $vars['internalname']; ?>'); 
				    } 
				}; 
